  ...
  return (
    <section className="dashboard">
      ...
      <section className="intro" style={introstyle}>
        <p>
          The <b>Pareto principle</b> (also known as the <b>80/20 rule</b>, the{" "}
          <b>law of the vital few</b>, or the{" "}
      ...
      <section className="paragraph" style={paragraphstyle}>
        <p>
          ...
          dollar from that person. Everyone gets his turn to trade with everyone
          else.If anyone ends up with zero dollar he will be out of the trading.
        </p>
      </section>
      ...
      <section className="paragraph" style={paragraphstyle}>
        <p>
          ...
          people who won more they got more chances of staying in the game than
          those who got less money in their pocket. That's why their chances
          help them to earn even more. And people who drops to zero drops their
          probability of earning money to zero too.
        </p>
      </section>
      ...
      <section className="paragraph">
        <p>
          This simulation only used the probability factor of coin flip. But in
          real life there are many probability factors that add up in 80/20
          rule. Which makes the distribution curve even more accurate to the
          law. It's not always exactly maintaining 80/20 distribution. But it's
          a benchmark. It follows the <b>Law of Economic Productivity.</b>.
        </p>
      </section>
